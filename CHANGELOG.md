...
Author: olefard <olefard@gmail.com>
Date: 27.07.2026 14:52:20

classic
 - исправлено продолжение печати в методе WaitForPrinting
 - добавлено свойство CashTotal для методов CashIncome и CashOutcome
 - добавлено свойство LicenseValidationStatus для метода ReadFeatureLicenses
 - добавлены параметры модели DPE_f57_commercial_license_is_active и DPE_f58_legal_license_is_active
 - реализованы методы GetIBMStatus и GetShortIBMStatus
 - добавлен метод FNCheckItemBarcode2 в c-интерфейс

cppbase
 - исправлено описание ошибки 49
 - добавлено поле "статус лицензии в ккт" в ответе команды "чтение функциональных лицензий"
 - добавлена обработка поля "наличность в ккт" в ответе команд "внесение" и "выплата"
 - добавлены бит 57 "Лицензия на коммерческие функции действительна" и бит 58 "Лицензия на законодательные функции действительна" в команду F7h "Запрос параметров модели"
 - исправлена передача ИНН при проверке лицензии на сервере ИТС

html_test
 - добавлено история команд для поля "Команда"
 - исправлен сброс декларативного документа при переходе в другие разделы
 - добавлены кнопки "Состояние IBM" и "Короткое состояние IBM"

declarative
 - исправлена передача атрибута industry_property

### 1.9.0-36-gbab9f4b

Revision: bab9f4bcb855d1728e77278141132a36a7b7da92
Author: olefard <olefard@gmail.com>
Date: 29.06.2026 22:00:38

classic
 - добавлен метод ITSLicenseIssue
 - добавлены свойства LicenseVersion, LicenseINN и LicenseCommercialStatus
 - добавлено свойство LicensePiotStatus
 - исправлена передача русских строк в C# обертке
 - добавлены методы SaveCashRegs и LoadCashRegs
 - ReadTable, WriteTable снова используют пароль из SysAdminPassword
 - добавлены параметры модели для активных интерфейсов ККТ
 - добавлен метод FNReadLastNotificationAsString
 - добавлена реализация методов ReadEcrStatus и ReadDeviceMetrics
 - исправлен экспорт коллбеков в java
 - исправлена отправка TLV размером 248 и 249 байт
 - добавлено свойство FNMarkingFillPercentage
 - добавлен параметр модели "Тип денежного ящика"
 - добавлен метод FNBuildRegistrationReport2, он использует свойства WorkModeEx и RegistrationReasonCodeEx
 - добавлены параметр модели "Версия ККТ (тег 1188)" и свойство ModelParamValueStr для его чтения
 - добавлен метод FNOpenCheck, он использует те же значения CheckType, что и FNOperation

classic_java
 - перенесена загрузка библиотеки из статического конструктора classic_interface в первое обращение к любому типу библиотеки

html_test
 - добавлена кнопка "Проверить наличие лицензий на сервере ИТС"
 - добавлена вкладка "03. ФН Чеки/Теги ОФД"
 - добавлен вывод лицензии на комерческие функции и функции ТС ПИоТ

cppbase
 - добавлена проверка лицензий на сервере ИТС после закрытия смены
 - доработан обмен при получении NAK и таймаута ACK
 - добавлена команда GetFsBufferData2Command(FF30h) с параметром тип буфера(1 байт)
 - добавлен тип буфера 252 "уведомление о реализации маркированной продукции"
 - добавлены описания тега 2116 и документа 82
 - исправлена выдача названий регистров
 - добавлено описание ошибок 217,219,220
 - добавлены активные интерфейсы ККТ в команду F7h "Расширенный запрос параметров модели"
 - добавлены описания операционных регистров 204-217
 - добавлена почти-NFKD-нормализация в метод utf8_to_cp1251
 - добавлен бит 56 "Тип денежного ящика" в параметры модели
 - добавлено поле "Версия ККТ (тег 1188)" в ответ команды F7h "Расширенный запрос"
 - исправлено описание ошибки B9h

console_test
 - добавлена команда its-license-issue
 - добавлен вывод лицензии на коммерческие функции в команду print-feature-licenses
 - обновлен встроенный html-тест

io
 - добавлена установка экслюзивного режима под линуксом
 - добавлена поддержка bluetooth low energy под windows

one_s
 - исправлено отключение печати на КЯ

linux
 - убрана версия из имен файлов so, удалены симлинки из архивов

### 1.8.0-1

Revision: eca4f1479b6d1a6518f0faaba7f7b557bc44e5d9
Author: olefard <olefard@gmail.com>
Date: 25.02.2026 13:07:39

ci
 - исключены библиотеки 1с из архивов драйверов

classic
 - добавлены коды чеков коррекции в описание ECRMode8Status

cppbase
 - добавлены описания чеков коррекции
 - добавлено ограничение по максимальному размеру тега типа "строка" в соответствии с ФФД
 - исправлена длина тега 1227 на 256

console_test
 - обновлен встроенный html_test до 1.8.0

one_s
 - исправлена передача информации о покупателе
...
console_test
 - добавлен вывод лицензии на НДС 22%
 - обновлен встроенный html_test до 1.7.0

classic
 - исправлен метод PrintBarcodeLine(Печать штрихкода линией)
 - исправлена передача пароля в командах ReadTable, ReadTable2, WriteTable, WriteTable2

one_s
 - исправлена передача даты коррекции
 - заменен параметр "Печатать ненулевые скидки" на "Печать скидок(0 - не печатать, 1 - печатать "сумма без скидки/Сумма скидки", 2 - печатать "СКИДКА   ")"
 - исправлены значения подключения по умолчанию под андроид
 - исправлена печать скидок шрифтом 0
 - добавлен параметр только для чтения "Параметры устройства"/"Лог драйвера"
 - добавлена функция "Открыть папку с логом драйвера"
 - исправлена передача адреса и места расчетов на КЯ
 - добавлено включение печати при печати текстовых документов
 - добавлено восстановление Т17П71 после печати чека; убрана запись Т17П71=0, если т17п71=2
 - изменена сборка под android на использование c++_static
 - исправлен тип аргумента у метода printCheckCopy(НапечататьКопиюЧека)
 - добавлено управление заменой ндс 20 на 22 перед пробитием чека коррекции для ФФД 1.05

### 1.7.0-16

Revision: a8ebf565c1957df595827f038a0103fdfb767129
Author: olefard <olefard@gmail.com>
Date: 11.12.2025 19:36:39

cppbase
 - исправлена обработка ответа на команду FF3Eh "Закрыть фискальный режим"
 - добавлено описание команд FF7Bh, FF7Ch в логе
 - добавлена команда FF7Ch "Сформировать чек коррекции V4"
 - добавлена поддержка терминала A8900

classic
 - добавлен метод FNBuildCorrectionReceipt4 и свойства Summ17 и Summ18

one_s
 - добавлено формирование чека коррекции под ФФД 1.05 с НДС 22
 - добавлена поддержка страниц 16 Кб на 64-разрядных устройствах с ОС Android

console_test
 - обновлен html-test до 1.5.0

### 1.7.0-9

Revision: 188a987ef4ee1e305069b0e3f341816aa7570f1c
Author: olefard <olefard@gmail.com>
Date: 08.12.2025 14:26:16

classic
 - добавлено заполнение поля DigitalSign после вызова ReadFeatureLicenses
 - добавлен метод FNCloseCheckEx4 и свойства TaxValue11, TaxValue12
 - добавлены параметры модели(DPE_KktFiscTableNumber, DPE_RegionalTableNumber, DPE_MappingTax20in22FieldNumber)
 - реализованы методы ReadTable2 и WriteTable2
 - доработана отмена чека системным администратором

console_test
 - обновлен встроенный html-тест до 1.3.1

cppbase
 - добавлены в команду F7 параметры модели(номер таблицы параметров регистрации кассы, номер таблицы "ЗАМЕНА НДС 20 на 22", номер поля "ЗАМЕНА НДС 20 на 22")
 - исправлены названия тегов НДС
 - добавлена команда FF7Bh "Закрытие чека расширенное вариант №4"

one_s
 - добавлена настройка "Передавать адрес и место расчета"
 - для драйверов, соответствующим требованиям ниже 4.7, добавлена настройка "Заменять НДС 20 на 22"

NOTE: требуется прошивка ККТ с поддержкой НДС 22%

### 1.7.0

Revision: e60421938d61c619ddf5525658d02548296b5a2c
Author: olefard <olefard@gmail.com>
Date: 11.11.2025 13:19:12

classic
 - добавлен метод FNGetReceiptFillPercentage "Получить процент заполненности ФН в чеке"
 - добавлены новые налоги 11(НДС 22%) и 12(22/122)

console_test
 - обновлен встроенный html-тест до 1.3.0

cppbase
 - добавлена команда FsGetReceiptMemoryUsageCommand "Получить процент заполненности ФН в чеке"
 - добавлено описание битов 50-55 в параметрах модели
 - добавлено описание регистров 4491-4522(оборот и накопление налогов НДС 22% и НДС 22/122)

one_s
 - добавлена поддержка требований 4.7
...
Author: olefard <olefard@gmail.com>
Date: 10.10.2025 13:22:45

console_test
 - исправлен адрес сервера html-test'а по умолчанию под линукс

cppbase
 - убрана возможность отключения логгирования нижнего уровня протокола

one_s
 - исправлена медленная печать текстовых документов на КЯ
 - исправлено падение драйвера под Android

### 1.6.6-45

Revision: b95b67994f83e5b582dc4d405a5281fb3c428d32
Author: olefard <olefard@gmail.com>
Date: 25.09.2025 16:48:01

cppbase
 - исправлено описание ошибки 119

one_s
 - исправлена команда ПодтвердитьКМ

console_test
 - обновлен встроенный html-тест до 1.2.38
